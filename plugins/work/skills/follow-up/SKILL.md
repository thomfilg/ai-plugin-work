...
> if [ -f "${CLAUDE_PLUGIN_ROOT:-/nonexistent}/skills/follow-up/SKILL.md" ] &&
>    [ "${CLAUDE_PLUGIN_ROOT}/skills/follow-up/SKILL.md" -ef "$SKILL_MD" ]; then
...
> argument (e.g. the ticket id) is the text after the `$follow-up` skill
