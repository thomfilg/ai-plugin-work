...
> if [ -f "${CLAUDE_PLUGIN_ROOT:-/nonexistent}/skills/tests-review/SKILL.md" ] &&
>    [ "${CLAUDE_PLUGIN_ROOT}/skills/tests-review/SKILL.md" -ef "$SKILL_MD" ]; then
...
> argument (e.g. the ticket id) is the text after the `$tests-review` skill
