...
> if [ -f "${CLAUDE_PLUGIN_ROOT:-/nonexistent}/skills/tests-create/SKILL.md" ] &&
>    [ "${CLAUDE_PLUGIN_ROOT}/skills/tests-create/SKILL.md" -ef "$SKILL_MD" ]; then
...
> argument (e.g. the ticket id) is the text after the `$tests-create` skill
