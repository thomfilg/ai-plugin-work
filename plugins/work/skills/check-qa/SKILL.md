...
> if [ -f "${CLAUDE_PLUGIN_ROOT:-/nonexistent}/skills/check-qa/SKILL.md" ] &&
>    [ "${CLAUDE_PLUGIN_ROOT}/skills/check-qa/SKILL.md" -ef "$SKILL_MD" ]; then
...
> argument (e.g. the ticket id) is the text after the `$check-qa` skill
