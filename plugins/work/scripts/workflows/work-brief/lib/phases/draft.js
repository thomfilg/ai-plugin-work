...
function instructions(ctx) {
  ...
  return [
    ...
    "The spec step's `surface_audit` treats a backticked identifier in this brief as a claim that the identifier EXISTS in the sibling-owned file named on the same line. That is only true of the claim sections (Requirements, Out of scope, Constraints, Success Metrics) — `## Open Questions` and every `Searched:` annotation are exempt, so write those in whatever notation reads best. In the claim sections, backtick an identifier when you mean \"this symbol exists\", and leave prose in plain text.",
    '',
