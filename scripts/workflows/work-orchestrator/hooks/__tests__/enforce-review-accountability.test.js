 ...
 * are required.
 *
 * Run with: node --test workflows/work-orchestrator/hooks/__tests__/enforce-review-accountability.test.js
 */
...
const FOLLOW_UP_INPUT = {
  tool_name: 'Bash',
  tool_input: { command: 'node workflows/work-orchestrator/scripts/follow-up-pr.js' },
};
