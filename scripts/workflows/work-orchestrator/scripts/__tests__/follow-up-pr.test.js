...
describe('getCodeContext', () => {
  it('returns context lines around the target line', () => {
    ...
    const result = getCodeContext('scripts/workflows/work-orchestrator/scripts/__tests__/follow-up-pr.test.js', 1, 1);
  ...
  it('marks the correct line with >>>', () => {
    const result = getCodeContext('scripts/workflows/work-orchestrator/scripts/__tests__/follow-up-pr.test.js', 3, 1);
    assert.ok(result);
  ...
  it('handles out-of-range line numbers gracefully', () => {
    const result = getCodeContext(
      'scripts/workflows/work-orchestrator/scripts/__tests__/follow-up-pr.test.js',
      999999,
      1
    );
  ...
  it('handles line 1 without negative index', () => {
    const result = getCodeContext('scripts/workflows/work-orchestrator/scripts/__tests__/follow-up-pr.test.js', 1, 3);
    assert.ok(result, 'should return context');
