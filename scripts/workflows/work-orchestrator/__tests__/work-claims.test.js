 ...
 *
 * Run: node --test workflows/work-orchestrator/__tests__/work-claims.test.js
 */
...
describe('R5 — does not perturb session-guard / work-state surfaces', () => {
  ...
  it('work-state keeps claimTask reachable (spec verification checklist)', () => {
    // Spec verification checklist requires `GREP workflows/work-orchestrator/work-state.js
