 ...
 * Run: node --test workflows/work-orchestrator/__tests__/complete-deadlock.test.js
 */
...
describe('GH-106: complete step deadlock fix', () => {
  ...
  describe('6. workflows/work-orchestrator/steps/complete.js: complete step prompt includes archival', () => {
