 ...
 * identical output.
 *
 * Run: node --test workflows/work-orchestrator/steps/__tests__/step-modules.test.js
 */
...
describe('step modules', () => {
  ...
  // workflows/work-orchestrator/steps/index.js so the pipeline (and any external consumer
