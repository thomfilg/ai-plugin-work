 ...
 *
 * Usage:
 *   node qa-progress.js init APPSUPEN-815 as-dashboard http://host.docker.internal:5173
 *   node qa-progress.js start-test APPSUPEN-815 as-dashboard "navigation_test"
 *   node qa-progress.js complete-test APPSUPEN-815 as-dashboard "navigation_test" pass "01-nav.png"
 *   node qa-progress.js fail-test APPSUPEN-815 as-dashboard "navigation_test" "Element not found"
 *   node qa-progress.js infrastructure-failure APPSUPEN-815 as-dashboard "Playwright unavailable"
 *   node qa-progress.js complete APPSUPEN-815 as-dashboard pass
 *   node qa-progress.js get APPSUPEN-815 as-dashboard
 */
