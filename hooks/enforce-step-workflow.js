...
const WORKFLOWS = [
  {
    ...
    commandMap: [
      { step: STEPS.ticket,           tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.ticket}\\b`, 'i') },
      { step: STEPS.brief,            tool: ['Task', 'Agent'], field: 'subagent_type', pattern: /^(work-workflow:)?brief-writer$/ },
      { step: STEPS.brief,            tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.brief}\\b`, 'i') },
      { step: STEPS.spec,             tool: ['Task', 'Agent'], field: 'subagent_type', pattern: /^(work-workflow:)?spec-writer$/ },
      { step: STEPS.spec,             tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.spec}\\b`, 'i') },
      ...
      { step: STEPS.quality,          tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.quality}\\b`, 'i') },
      ...
      { step: STEPS.cleanup,          tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.cleanup}\\b`, 'i') },
      ...
      { step: STEPS.ready,            tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.ready}\\b`, 'i') },
      { step: STEPS.ci,               tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.ci}\\b`, 'i') },
      { step: STEPS.reports,          tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.reports}\\b`, 'i') },
      { step: STEPS.complete,         tool: ['Task', 'Agent'], field: 'description',   pattern: new RegExp(`\\b${STEPS.complete}\\b`, 'i') },
    ],
